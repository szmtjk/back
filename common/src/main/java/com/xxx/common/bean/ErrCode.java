...
public enum ErrCode {
    ...
    EXCEL_FILE_NOT_EXIST(40100, "文件不存在"),
    EXCEL_DISPOSE_TYPE_NOT_MATCHED(40101, "文件处理类型不匹配"),
    EXCEL_EXAM_DETAIL_SAVE_ERR(40102, "体检明细保存失败"),
    EXCEL_EXAM_CATEGORY_SAVE_ERR(40103, "体检类别保存失败"),
    EXCEL_EXAM_SAVE_ERR(40104, "体检概要信息保存失败"),
    EXCEL_DISPOSE_ERR(40199, "文件解析失败"),
